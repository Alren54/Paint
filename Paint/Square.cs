...
namespace Paint
{
    class Square : Shape
    {
        public Square(Point shapeSize, Point shapeLocation, Color color, int colorIndex)
        {
        ...
        public override void Draw(Graphics g, Brush b, int shapeLocationX, int shapeLocationY, int selectedShapeSizeX, int selectedShapeSizeY)
        {
            ...
            g.FillRectangle(b, shapeLocationX, shapeLocationY, selectedShapeSizeX, selectedShapeSizeY);
        }
    }
}